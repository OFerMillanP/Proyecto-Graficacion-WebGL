    ...
    ImageLoader.load(
        ...
        function() {
            ...
            let entradasInv = [
                ...
                //Perillas
                new Perilla(
                    gl, Matrix4.multiply(Matrix4.rotateY(180), Matrix4.translate(new Vector3(-7.018, 3.125, 18.7722)))
                ),
                // entradas
                new Cuarto(
                ...
                //Perillas
                new Perilla(
                    gl, Matrix4.multiply(Matrix4.rotateY(180), Matrix4.translate(new Vector3(-7.018, 3.125, 38.7722)))
                ),
                // entradas
                new Cuarto(
                ...
                //Perillas
                new Perilla(
                    gl, Matrix4.multiply(Matrix4.rotateY(180), Matrix4.translate(new Vector3(-7.018, 3.125, 58.7722)))
                ),
                // entradas
                new Cuarto(
                ...
                //Perillas
                new Perilla(
                    gl, Matrix4.multiply(Matrix4.rotateY(180), Matrix4.translate(new Vector3(-7.018, 3.125, 78.7722)))
                ),
                // entradas
                new Cuarto(
